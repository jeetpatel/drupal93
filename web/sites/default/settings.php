...
function ErrorHandler($type, $message, $file, $line)
{
    ...
    return(print(@sprintf("%s Custom Error in file \xBB%s\xAB at line %d: %s\n", $name, @basename($file), $line, $message)));
};
 ...
 * @endcode
 */
$settings['hash_salt'] = 'z8INdbQzh1DHUjO2yNBHcgZ_DzFFRr5UGihQv-f77Biqj5hoaQjj7CFcg6vTtwR_6L1ha_SE6w';
...
$settings['config_sync_directory'] = 'sites/default/files/config_uWEnVUl2PhTWpl1cF9tJtDcQzXI7p16fyA6hukLhzBd60qznLHooEd69MY0olGZkv0DuIW2I-Q/sync';
...
$config['system.site']['name'] = 'System site name overridden 1.3';
