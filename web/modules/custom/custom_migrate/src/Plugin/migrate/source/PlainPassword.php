...
/**
 * Source Plugin for Plain Password migration.
 *
 * @MigrateSource(
 *   id = "plain_password_data"
 * )
 */
class PlainPassword extends SqlBase {
  ...
  public function query() {
    ...
    \Drupal::logger('migrate_source')->info('plain_password_data');
    return $this->select('plain_password', 'pp')
      ->fields('pp', $fields);
  }
