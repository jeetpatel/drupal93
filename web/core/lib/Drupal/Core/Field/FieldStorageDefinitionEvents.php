...
final class FieldStorageDefinitionEvents
{
   ...
   * @var string
   */
    public const CREATE = 'field_storage.definition.create';
     ...
     * @var string
     */
    public const UPDATE = 'field_storage.definition.update';
     ...
     * @var string
     */
    public const DELETE = 'field_storage.definition.delete';
}
