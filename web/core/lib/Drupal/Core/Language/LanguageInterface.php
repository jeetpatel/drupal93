...
interface LanguageInterface
{
   ...
   */
    public const LANGCODE_SYSTEM = 'system';
     ...
     */
    public const LANGCODE_NOT_SPECIFIED = 'und';
     ...
     */
    public const LANGCODE_NOT_APPLICABLE = 'zxx';
     ...
     */
    public const LANGCODE_DEFAULT = 'x-default';

    /**
     * Language code referring to site's default language.
     */
    public const LANGCODE_SITE_DEFAULT = 'site_default';
     ...
     */
    public const VALID_LANGCODE_REGEX = '[a-zA-Z]{1,8}(-[a-zA-Z0-9]{1,8})*';

    /**
     * The language state when referring to configurable languages.
     */
    public const STATE_CONFIGURABLE = 1;
     ...
     */
    public const STATE_SITE_DEFAULT = 4;

    /**
     * The type of language used to define the content language.
     */
    public const TYPE_CONTENT = 'language_content';
     ...
     */
    public const TYPE_URL = 'language_url';
