...
class RequestSanitizer
{
   ...
   */
    public const SANITIZED = '_drupal_request_sanitized';

    /**
     * The name of the setting that configures the sanitize input safe keys.
     */
    public const SANITIZE_INPUT_SAFE_KEYS = 'sanitize_input_safe_keys';
     ...
     */
    public const SANITIZE_WHITELIST = 'sanitize_input_whitelist';

    /**
     * The name of the setting that determines if sanitized keys are logged.
     */
    public const SANITIZE_LOG = 'sanitize_input_logging';
