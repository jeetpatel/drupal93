...
class Tasks extends InstallTasks
{
   ...
   */
    public const MYSQL_MINIMUM_VERSION = '5.7.8';
     ...
     */
    public const MARIADB_MINIMUM_VERSION = '10.3.7';

    /**
     * Minimum required MySQLnd version.
     */
    public const MYSQLND_MINIMUM_VERSION = '5.0.9';

    /**
     * Minimum required libmysqlclient version.
     */
    public const LIBMYSQLCLIENT_MINIMUM_VERSION = '5.5.3';
