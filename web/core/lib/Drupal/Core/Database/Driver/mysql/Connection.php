...
class Connection extends DatabaseConnection
{
   ...
   */
    public const DATABASE_NOT_FOUND = 1049;
     ...
     * @var int
     */
    public const MIN_MAX_ALLOWED_PACKET = 1024;
