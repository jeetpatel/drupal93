...
class Drupal
{
   ...
   */
    public const VERSION = '9.2.7';

    /**
     * Core API compatibility.
     */
    public const CORE_COMPATIBILITY = '8.x';

    /**
     * Core minimum schema version.
     */
    public const CORE_MINIMUM_SCHEMA_VERSION = 8000;
     ...
     */
    public const MINIMUM_SUPPORTED_PHP = '7.3.0';
     ...
     */
    public const MINIMUM_PHP = '7.3.0';
     ...
     */
    public const MINIMUM_PHP_MEMORY_LIMIT = '64M';
     ...
     */
    public const RECOMMENDED_PHP = '7.4';
