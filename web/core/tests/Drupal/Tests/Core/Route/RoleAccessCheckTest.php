...
class RoleAccessCheckTest extends UnitTestCase
{
   ...
   */
    protected function getTestRouteCollection()
    {
        ...
        $route_collection->add('role_test_1', new Route(
            '/role_test_1',
            [
        ...
        $route_collection->add('role_test_2', new Route(
            '/role_test_2',
            [
        '_controller' => '\Drupal\router_test\TestControllers::test1',
      ],
        ...
        $route_collection->add('role_test_3', new Route(
            '/role_test_3',
            [
        '_controller' => '\Drupal\router_test\TestControllers::test1',
      ],
        ...
        $route_collection->add('role_test_4', new Route(
            '/role_test_4',
            [
        '_controller' => '\Drupal\router_test\TestControllers::test1',
      ],
        ...
        $route_collection->add('role_test_5', new Route(
            '/role_test_5',
            [
        '_controller' => '\Drupal\router_test\TestControllers::test1',
      ],
        ...
        $route_collection->add('role_test_6', new Route(
            '/role_test_6',
            [
        '_controller' => '\Drupal\router_test\TestControllers::test1',
      ],
